                        ...
                        <form onSubmit={submit} className="space-y-5">
                            <div>
                                ...
                                <TextInput
                                    ...
                                    type="email"
                                    value={data.email}
                                    className="mt-1 block w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:border-[#B94D4D] focus:ring focus:ring-[#B94D4D] focus:ring-opacity-20 transition-colors"
                            ...
                            <div className="flex items-center">
                                <Checkbox
                                    ...
                                    className="h-4 w-4 text-[#B94D4D] border-white/20 rounded bg-white/5 focus:ring-[#B94D4D] transition-colors"
                                />
